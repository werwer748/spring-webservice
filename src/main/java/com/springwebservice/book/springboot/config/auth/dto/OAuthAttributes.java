...
public class OAuthAttributes {
    ...
    // OAuth2User에서 반환하는 사용자정보는 Map이기 때문에 값 하나하나를 변환해야 함.
    ...
    /**
     * User Entity 생성
     * OAuthAttributes에서 이 엔티티를 생성하는 시점은 처음 가입할 때(CustomOAuth2UserService > saveOrUpdate > orElse 참고)
     * 가입시 기본 권한을 위해 Role.GUEST 사용
     */
